...
export const CardGalleryHoverEffect = ({
  items,
  className,
}: {
  items: Asset[];
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl bg-zinc-50 h-full w-full p-4 overflow-hidden border border-transparent group-hover:border-slate-200 relative z-20",
        className
      )}
    >
